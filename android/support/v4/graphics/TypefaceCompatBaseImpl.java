...
class TypefaceCompatBaseImpl implements TypefaceCompatImpl {
    ...
    class C03391 implements StyleExtractor<FontInfo> {
        C03391() {
        }
    ...
    class C03402 implements StyleExtractor<FontFileResourceEntry> {
        C03402() {
        }
    ...
    protected FontInfo findBestInfo(FontInfo[] fonts, int style) {
        return (FontInfo) findBestFont(fonts, style, new C03391());
    }
    ...
    private FontFileResourceEntry findBestEntry(FontFamilyFilesResourceEntry entry, int style) {
        return (FontFileResourceEntry) findBestFont(entry.getEntries(), style, new C03402());
    }
