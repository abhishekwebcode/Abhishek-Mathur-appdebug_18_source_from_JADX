...
public class MediaSessionCompat {
    ...
    class C03501 extends Callback {
        C03501() {
        }
    }

    class C03512 extends Callback {
        C03512() {
        }
    }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        final String mTag;
        private final Token mToken;
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C03521();
        ...
        class C03521 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C03521() {
            }
