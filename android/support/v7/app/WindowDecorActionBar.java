...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C04081();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C04092();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C03683();

    class C03683 implements ViewPropertyAnimatorUpdateListener {
        C03683() {
        }
    ...
    class C04092 extends ViewPropertyAnimatorListenerAdapter {
        C04092() {
        }
