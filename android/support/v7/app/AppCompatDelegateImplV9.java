...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements Callback, Factory2 {
    ...
    class C02365 implements Runnable {
        ...
        class C04051 extends ViewPropertyAnimatorListenerAdapter {
            C04051() {
            }
        ...
        public void run() {
            ...
            if (AppCompatDelegateImplV9.this.shouldAnimateActionModeView()) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C04051());
                return;
            }
            AppCompatDelegateImplV9.this.mActionModeView.setAlpha(1.0f);
            AppCompatDelegateImplV9.this.mActionModeView.setVisibility(0);
    ...
    class C03642 implements OnApplyWindowInsetsListener {
        C03642() {
        }
    ...
    class C03653 implements OnFitSystemWindowsListener {
        C03653() {
        }
    ...
    class C03664 implements OnAttachListener {
        C03664() {
        }
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        class C04071 extends ViewPropertyAnimatorListenerAdapter {
            C04071() {
            }
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImplV9.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C04071());
            }
    ...
    class C04066 extends ViewPropertyAnimatorListenerAdapter {
        C04066() {
        }
        ...
        if (a.hasValue(C0239R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(subDecor, new C03642());
                } else {
                    ((FitWindowsViewGroup) subDecor).setOnFitSystemWindowsListener(new C03653());
                }
            ...
            contentView.setAttachListener(new C03664());
            return subDecor;
        }
        a.recycle();
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    if (shouldAnimateActionModeView()) {
                        ...
                        this.mFadeAnim.setListener(new C04066());
                    } else {
