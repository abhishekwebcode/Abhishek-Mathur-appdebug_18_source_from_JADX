...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    private final OnItemTouchListener mOnItemTouchListener = new C03922();
    ...
    class C03922 implements OnItemTouchListener {
        C03922() {
        }
    ...
    class C03945 implements ChildDrawingOrderCallback {
        C03945() {
        }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C03945();
            }
