...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C03881();
        ...
        private final Callback mVerticalBoundCheckCallback = new C03892();
        private int mWidth;
        ...
        class C03881 implements Callback {
            C03881() {
            }
    ...
    class C03854 implements ProcessCallback {
        C03854() {
        }
    ...
    class C03865 implements Callback {
        C03865() {
        }
    ...
    class C03876 implements Callback {
        C03876() {
        }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mViewInfoProcessCallback = new C03854();
        if (attrs != null) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C03865());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C03876());
    }
