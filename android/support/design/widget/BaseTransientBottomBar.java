...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    final Callback mManagerCallback = new C03173();
    ...
    class C03162 implements OnApplyWindowInsetsListener {
        C03162() {
        }
    ...
    class C03173 implements Callback {
        C03173() {
        }
    ...
    class C03184 implements OnDismissListener {
        C03184() {
        }
    ...
    class C03195 implements OnAttachStateChangeListener {
    ...
    class C03206 implements OnLayoutChangeListener {
        C03206() {
        }
    ...
    protected BaseTransientBottomBar(@NonNull ViewGroup parent, @NonNull View content, @NonNull ContentViewCallback contentViewCallback) {
        if (parent == null) {
            ...
            ViewCompat.setOnApplyWindowInsetsListener(this.mView, new C03162());
    ...
    final void showView() {
        if (this.mView.getParent() == null) {
            ...
            if (lp instanceof CoordinatorLayout.LayoutParams) {
                ...
                behavior.setListener(new C03184());
                clp.setBehavior(behavior);
                clp.insetEdge = 80;
            }
            this.mTargetParent.addView(this.mView);
        }
        this.mView.setOnAttachStateChangeListener(new C03195());
        if (!ViewCompat.isLaidOut(this.mView)) {
            this.mView.setOnLayoutChangeListener(new C03206());
